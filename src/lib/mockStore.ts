...
export const MOCK_ASSETS: Asset[] = [
  // 1. Dự án VMT Central Palm (TP.HCM)
  {
    ...
    legal_lot_code: 'Phân khu Palm Oasis-PO-BT-01',
  ...
  },
  {
    ...
    legal_lot_code: 'Phân khu Palm Oasis-PO-BT-02',
    business_project_name: 'Khu Đô Thị Central Palm',
  ...
  },
  {
    ...
    legal_lot_code: 'Phân khu Boulevard-BL-SH-05',
    business_project_name: 'Khu Đô Thị Central Palm',
    business_plot_code: 'PALM-BL-05',
    area: 160.0,
    map_sheet_no: '04',
    land_lot_no: '145',
    usage_purpose: 'Đất ở kết hợp thương mại dịch vụ (ODT)',
    usage_term_type: 'long_term',
  ...
  // 2. Dự án Spana Riverside (Bình Dương)
  {
    ...
    legal_lot_code: 'Phân khu River Park-RP-SH-08',
  ...
  },
  {
    ...
    legal_lot_code: 'Phân khu River Park-RP-LK-15',
    business_project_name: 'Spana Riverside',
  ...
  // 3. Dự án VMT Grand Marina (Đồng Nai)
  {
    ...
    legal_lot_code: 'Khu Trung Tâm Thương Mại-TMD-01',
  ...
  },
  {
    ...
    legal_lot_code: 'Tháp Marina Aqua (Tòa A)-A-2508',
    business_project_name: 'Tổ Hợp VMT Grand Marina',
  ...
  // 4. Dự án VMT Heritage Village Hội An (Quảng Nam)
  {
    ...
    legal_lot_code: 'Làng Di Sản Ven Sông-HV-VILLA-05',
    business_project_name: 'Khu Nghỉ Dưỡng VMT Heritage Village',
    business_plot_code: 'HERITAGE-V05',
    area: 580.0,
    map_sheet_no: '18',
    land_lot_no: '304',
    usage_purpose: 'Đất thương mại dịch vụ du lịch (TMD)',
    usage_term_type: 'fixed_date',
  ...
  },
  {
    ...
    legal_lot_code: 'Làng Di Sản Ven Sông-HV-VILLA-06',
    business_project_name: 'Khu Nghỉ Dưỡng VMT Heritage Village',
  ...
  // 5. Dự án VMT Dragon Bay (Đà Nẵng)
  {
    ...
    legal_lot_code: 'Tháp Dragon Sea View-DS-2104',
  ...
  },
  {
    ...
    legal_lot_code: 'Phố Đi Bộ Dragon Walk-DW-03',
    business_project_name: 'Khu Phức Hợp VMT Dragon Bay',
    business_plot_code: 'DRAGON-DW-03',
    area: 185.0,
    map_sheet_no: '22',
    land_lot_no: '190',
    usage_purpose: 'Đất ở kết hợp kinh doanh (ODT)',
    usage_term_type: 'long_term',
  ...
  // 6. Dự án VMT Capital Tower (Hà Nội)
  {
    ...
    legal_lot_code: 'Khối Văn Phòng Tháp Đông-VP-FL-18',
  ...
  },
  {
    ...
    legal_lot_code: 'Khối Đế Thương Mại-TTTM-FL-02',
    business_project_name: 'Tòa Nhà VMT Capital Tower',
  ...
  // 8. Dự án Sunset Horizon Phú Quốc (Kiên Giang)
  {
    ...
    legal_lot_code: 'Phân khu Cliff Villa-CV-VILLA-08',
    ...
    items: [
      {
        ...
        decided_by: { full_name: 'Lê Hoàng Nam (Quản Lý Kho Trung Tâm)', email: 'warehouse@btcvmt.vn' },
...
export const MOCK_ACTIVITY_LOGS: any[] = [
  {
    ...
    performer: { full_name: 'Lê Hoàng Nam (Quản Lý Kho Trung Tâm)', email: 'warehouse@btcvmt.vn' },
    warehouse_id: 'wh-01',
...
export const MOCK_NOTIFICATIONS: any[] = [
  {
    ...
    body: 'Quản lý kho Lê Hoàng Nam đã phê duyệt xuất kho GCN-HCM-2024-00189. Mã phiếu xuất: PX-2026/001.',
...
export const MOCK_REPORT_SNAPSHOTS: ReportSnapshot[] = [
  {
    ...
    report_data: [
      ...
      },
      {
        ...
        usage_purpose: 'Đất thương mại dịch vụ (TMD)',
        usage_term_label: 'Có thời hạn (theo GCN)',
...
export const mockStore = {
      ...
      if (filters.search) {
        ...
        assets = assets.filter(
          a =>
            ...
            a.legal_lot_code?.toLowerCase().includes(s) ||
            a.current_owner_entity?.name?.toLowerCase().includes(s) ||
  ...
  updateAppUserPassword: (userIdOrUsername: string, newPassword: string): void => {
    const cleanKey = userIdOrUsername.toLowerCase();
    const users = mockStore.getAppUsers();
    const updated = users.map(u => 
      (u.id === userIdOrUsername || u.username?.toLowerCase() === cleanKey) 
